bot = dofile('/home/werewolf/inline/data/utils.lua')
json = dofile('/home/werewolf/inline/data/JSON.lua')
...
BASE = '/home/werewolf/inline/bot/'
SUDO = 114979068 --sudo id
sudo_users = {114979068,123456789,Userid}
